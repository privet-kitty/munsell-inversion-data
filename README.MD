...
This repository provides fundamental datas for conversion from some color spaces (e.g. RGB) to Munsell color system. All datas are generated with color library [dufy](https://github.com/privet-kitty/dufy).
